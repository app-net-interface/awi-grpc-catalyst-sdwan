...
func (m *MockClient) GetACL(arg0 string) (*db.AppConnection, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetACL", arg0)
	ret0, _ := ret[0].(*db.AppConnection)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) ListACLs() ([]db.AppConnection, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) UpdateACL(arg0 *db.AppConnection, arg1 string) error {
	m.ctrl.T.Helper()
